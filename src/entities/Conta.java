...
public class Conta {
	...
	public void exibirMenuLogin(Usuario usuario) throws Exception {
		String[] opcoes = { "Saldo", "Sacar", "Depositar", "Extrato", "Perfil", "Sair da conta" };
			...
			switch (escolha) {
				...
				case 3:
					for (int i = 0; i < list.size(); i++) {
						JOptionPane.showMessageDialog(null, "Sua ultima saida de Extrato  é: " + usuario.getExtrato(),
								"Extrato", JOptionPane.INFORMATION_MESSAGE);
					}
					break;
				case 4:
					JOptionPane.showMessageDialog(null, usuario.toString(), "Perfil", JOptionPane.INFORMATION_MESSAGE);
					break;
	...
	public void exibirMenu() throws Exception {
		...
		ImageIcon logo = new ImageIcon("E:/ProjetoPOO/bro.jpeg");
